...
public:
	...
	bool				SDF_Revert_Rays;		// ci aj obratene luce
	...
	float				GPU_Work_Groups;		// nasobok jadier
	float				GPU_Work_Items;			// nasobok max work itemov
	...
	bool				VISUAL_Points;			// ci kreslim projektnute body
	...
	unsigned int DEBUG_Min_SDF;					// min hodnota sdf
	unsigned int DEBUG_Max_SDF;					// max hodnota sdf
	...
	unsigned int SDF_STATUS;					// percenta na kolko je sdf spocitane
