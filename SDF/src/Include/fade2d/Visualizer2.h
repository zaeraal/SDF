...
/** \brief Constructor
*
* @param filename is the name of the postscript file to be written
*/
	CLASS_DECLSPEC 
	Visualizer2(const std::string filename);
...
* Just a convencience function 
*/
	CLASS_DECLSPEC 
	void addObject(std::vector<Triangle2*> vT,const Color& c);
